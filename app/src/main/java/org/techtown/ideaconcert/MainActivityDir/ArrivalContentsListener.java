...
public class ArrivalContentsListener implements Response.Listener<String> {

    final int CONTENTS_WIDTH = 200, CONTENTS_HEIGHT = 250; // 큐레이션 컨텐츠의 가로, 세로 길이
    private LinearLayout contentsLayout;
    private Context context;

    public ArrivalContentsListener(LinearLayout layout, Context context) {
