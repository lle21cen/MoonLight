...
//    static final String SendConsultMailURL = ActivityCodes.DATABASE_IP + "GetContentsItem";
    static final String SendConsultMailURL = "lle21cen.cafe24.com/SendConsultMail.php";
...
//            int category_num = consultCategorySpinner.getSelectedItemPosition();
            ...
            Toast.makeText(ConsultActivity.this, ""+consult_category + " " + title + " " + content + " " + email, Toast.LENGTH_SHORT).show();
